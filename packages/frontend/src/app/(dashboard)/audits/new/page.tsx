  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Link href="/audits" className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
          <ArrowLeftIcon className="h-5 w-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">New Audit</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Create a new audit engagement</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* Scope & Objectives */}
        <div className="card p-6">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">Scope & Objectives</h2>
        ...
        {/* Audit Period */}
        <div className="card p-6">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">Audit Period</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        {/* Team Assignment */}
        <div className="card p-6">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 mb-4">Team Assignment</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
