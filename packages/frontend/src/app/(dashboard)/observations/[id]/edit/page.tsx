  ...
  if (!observation) {
    return (
      <div className="text-center py-12">
        <h3 className="text-lg font-medium text-gray-900">Observation not found</h3>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Link href={`/observations/${observationId}`} className="text-gray-400 hover:text-gray-600">
          <ArrowLeftIcon className="h-5 w-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Observation</h1>
          <p className="text-sm text-gray-500">{observation.globalSequence}</p>
        </div>
      </div>
